...
export function StoreFilters({
  ...
  return (
    <>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-4">
            <div className="flex-1 relative">
              ...
              <Input
                ...
                className="pl-12 h-12 border-0 bg-gray-100/80 backdrop-blur-sm rounded-2xl focus:ring-2 focus:ring-purple-500 transition-all"
              />
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <SelectTrigger className="h-12 border-0 bg-gray-100/80 rounded-2xl min-w-40">
              ...
              <div className="flex items-center gap-2 bg-gray-100/80 rounded-2xl p-1">
                <Button
              ...
              <Button
                ...
                className="lg:hidden h-12 rounded-2xl"
              >
      ...
      {/* Filters Sidebar */}
      <div className={`lg:w-80 space-y-6 ${show_filters ? 'block' : 'hidden lg:block'}`}>
        <div className="bg-white/60 backdrop-blur-lg rounded-3xl border border-gray-200/50 p-6 shadow-xl">
          ...
          <div className="space-y-6">
            ...
            {/* In Stock Only */}
            <div className="flex items-center space-x-3 p-4 rounded-2xl bg-gray-50/50">
              <Checkbox
                id="in_stock"
            ...
            {/* Sort By */}
            <div>
              <label className="text-sm font-semibold mb-3 block text-gray-700">Sort By</label>
              <Select
                value={filters.sort_by}
                onValueChange={(value: any) => on_filters_change({ sort_by: value })}
              >
                <SelectTrigger className="h-12 border-0 bg-gray-50/50 rounded-2xl">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
        ...
        <div className="bg-gradient-to-br from-purple-500 to-pink-500 rounded-3xl p-6 text-white">
          <h3 className="text-lg font-bold mb-2">Store Stats</h3>
