...
export function ProductModal({ product, is_open, on_close }: ProductModalProps) {
  ...
  return (
    <Dialog open={is_open} onOpenChange={on_close}>
      <DialogContent className="max-w-7xl h-[95vh] overflow-hidden p-0 bg-white border border-gray-200/50 shadow-2xl rounded-3xl">
        ...
        <Button
          ...
          variant="ghost"
          size="sm"
          className="absolute top-4 right-4 z-50 w-10 h-10 rounded-full bg-white/90 hover:bg-white shadow-lg border border-gray-200"
        >
          <X className="w-5 h-5" />
        </Button>
          ...
          <ScrollArea className="flex-1">
            <div className="grid grid-cols-1 lg:grid-cols-2 min-h-full">
                  ...
                  <div className="relative aspect-square overflow-hidden rounded-2xl bg-white shadow-lg">
                    ...
                    <div className="absolute top-6 left-6 space-y-3">
                      ...
                      {product.rating && product.rating >= 4.5 && (
                        <Badge className="bg-gradient-to-r from-yellow-400 to-orange-400 text-white border-0 shadow-lg px-4 py-2 text-sm font-bold">
                    ...
                    <div className="flex space-x-4 overflow-x-auto pb-2">
                      {images.map((image, index) => (
                        <button
                          ...
                          className={`flex-shrink-0 w-20 h-20 rounded-xl border-3 overflow-hidden transition-all duration-300 ${
              ...
              <div className="p-8 space-y-8">
                {/* Header */}
                <div>
                  <Badge variant="outline" className="mb-4 bg-purple-50 text-purple-700 border-purple-200 px-3 py-1">
                    {product.category.name}
                  </Badge>

                  <h1 className="text-4xl font-black text-gray-800 mb-4 leading-tight">{product.name}</h1>

                  {product.rating && (
                    <div className="flex items-center mb-6">
                      <div className="flex items-center bg-yellow-50 rounded-xl px-4 py-2 mr-4">
                  ...
                  <div className="flex items-center space-x-4 mb-6">
                    <span className="text-5xl font-black text-gray-800">${calculate_price().toFixed(2)}</span>
                    {product.original_price && (
                      <>
                ...
                {Object.keys(variants_by_type).length > 0 && (
                  <div className="bg-gradient-to-r from-gray-50 to-purple-50 rounded-2xl p-6 space-y-6">
                        ...
                        >
                          {variants.map((variant) => (
                            <div key={variant.id} className="flex items-center">
                              ...
                              <Label
                                htmlFor={variant.id}
                                className={`cursor-pointer px-6 py-3 text-sm font-semibold border-2 rounded-xl transition-all duration-300 ${
                              ...
                              >
                                ...
                                {variant.price_modifier && (
                                  <span className="ml-2 text-xs opacity-75">(+${variant.price_modifier})</span>
                                )}
                              </Label>
                            </div>
                          ))}
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      <div className="flex items-center bg-white rounded-xl border-2 border-gray-200 overflow-hidden shadow-sm">
                        ...
                        <span className="text-xl font-bold px-6 min-w-16 text-center bg-gray-50">{quantity}</span>
                        <Button
                          variant="ghost"
                          size="sm"
                ...
                <div className="flex space-x-4">
                  <Button
                    ...
                    className="flex-1 h-14 text-xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-2xl shadow-xl disabled:opacity-50"
                  >
                    {is_adding_to_cart ? (
                  ...
                  <Button
                    variant="outline"
                    size="lg"
                    className="h-14 w-14 rounded-2xl border-gray-300 hover:bg-gray-50"
                  >
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div className="flex items-center space-x-3 bg-orange-50 rounded-xl p-4">
            ...
            <div className="border-t border-gray-200 bg-gray-50/50 p-8">
              <Tabs defaultValue="features" className="w-full">
                <TabsList className="grid w-full grid-cols-3 bg-white rounded-2xl p-2 h-14 shadow-sm">
                  <TabsTrigger value="features" className="rounded-xl font-semibold text-lg">
                    Features
                  </TabsTrigger>
                  <TabsTrigger value="specifications" className="rounded-xl font-semibold text-lg">
                    Specifications
                  </TabsTrigger>
                  <TabsTrigger value="reviews" className="rounded-xl font-semibold text-lg">
                    Reviews
                  </TabsTrigger>
                </TabsList>
                    ...
                    {product.features ? (
                      <div className="grid gap-4">
                        {product.features.map((feature, index) => (
                          <div key={index} className="flex items-start space-x-4 bg-gray-50 rounded-xl p-4">
                      ...
                      <p className="text-gray-600 text-lg">No features listed for this product.</p>
                    )}
                  </div>
                </TabsContent>
                ...
                <TabsContent value="reviews" className="mt-8">
                  <div className="bg-white rounded-2xl p-8 shadow-sm">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      {product.rating && (
                        <div className="flex items-center space-x-3 bg-yellow-50 rounded-xl px-4 py-2">
                          <div className="flex items-center">
                            {Array.from({ length: 5 }, (_, i) => (
                              <Star
                                key={i}
                    ...
                    <div className="text-center py-16 bg-gray-50 rounded-2xl">
                      ...
                      <h4 className="text-2xl font-bold text-gray-800 mb-4">Reviews Coming Soon!</h4>
                      <p className="text-gray-600 mb-6 text-lg">Be the first to review this amazing product.</p>
                      <Button className="bg-purple-600 hover:bg-purple-700 text-white rounded-xl px-8 py-3 text-lg">
                        Write a Review
                      </Button>
                    </div>
                  </div>
